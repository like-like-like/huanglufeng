...
<head>
    ...
    <script type="text/javascript">
        ...
        //异步新增
        function addEmp() {
            $.post("/emp_add",$("#tt").serialize(),function (result) {
...
<div class="layui-container" style="margin-top: 5px">
    <form class="layui-form" action="#" method="post" id="tt">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <img alt="个人一寸照片" src="/media/images/no.jpg"  id="img1" width="200px" height="300px">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    //初始化数据
    function initData() {
        $.getJSON("/deaprt_findDeparts",null,function(arr){
